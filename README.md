...
You can get the latest Playstore version here on [Playstore](https://play.google.com/store/apps/details?id=com.fenchtose.flutter&referrer=utm_source%3Dgithub) - or download directly - [0.3.1](https://github.com/jayrambhia/MovieRatings/releases/download/v0.3.1/flutter_v0.3.1.apk)
