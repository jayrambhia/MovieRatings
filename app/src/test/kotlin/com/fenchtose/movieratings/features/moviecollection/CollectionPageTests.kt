...
//        }
    ...
    private val collection = MovieCollection(124, "cool collection", listOf(m1, m2))

    private val collectionEntry = MovieCollectionEntry.create(collection.id, m1.imdbId)
